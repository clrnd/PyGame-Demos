...
pygame.time.set_timer(BUMP,500)
...
while loop: ### MAIN LOOP ###
	...
	if not osc:
		if pygame.time.get_ticks() - tocks > 15000:
			speed = 50
		if pygame.time.get_ticks() - tocks > 19000:
			speed = 30
		if pygame.time.get_ticks() - tocks > 27000:
			speed = 10
		if pygame.time.get_ticks() - tocks > 33500:
			speed = 300
		if pygame.time.get_ticks() - tocks > 34500:
			osc = True
